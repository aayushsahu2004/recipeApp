        ...
        <div className='w-full h-[120vh] px-20 flex items-center justify-center'>
            <div className='w-2/3 h-full bg-red'>
                ...
                <form onSubmit={SubmitHandler}>
                    ...
                    <textarea onChange={(e) => setdiscription(e.target.value)} value={discription} className='w-full py-3 px-6 border border-zinc-400 rounded-md mb-6 resize-none' placeholder='Recipe Discription'></textarea>
