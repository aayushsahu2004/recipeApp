const Home = () => {
    return (
        <div className="w-full h-[86vh] px-20 flex items-center justify-between">
            <div className="w-1/2 h-96">
                <h1 className="text-8xl font-bold mb-2">Testy Food</h1>
                <h1 className="text-8xl font-bold text-[#FC815F] mb-6">Collections</h1>
