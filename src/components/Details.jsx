...
const Details = () => {
    ...
    return recipeDets ? (
        <div className="w-full h-[89.2vh] px-20 overflow-hidden">
            <div className="details w-full h-full flex">
                <div className="desc w-1/2 py-5 px-10 flex flex-col items-center">
                ...
                <div className="desc w-1/2 px-10 py-5 overflow-auto">
